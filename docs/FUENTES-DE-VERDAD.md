...
| **Bus general CAN + flasheo por CAN (PROPUESTA, post-Incheon)** | `docs/decisions/2026-06-03-bus-can-general-y-flasheo-por-can.md` — propuesta de migrar el transporte inter-placa de UART punto-a-punto a un **bus CAN único** (3 Teensy + 4 OpenMV + bridge ESP32-S3, transceiver SN65HVD230, JST-GH) y de **flashear firmware por el bus** (FlasherX, integridad CRC en 3 capas, gate de mantenimiento). **Status: propuesta, NO validada en banco.** | **NO reemplaza** el diseño VIVO de comunicaciones UART (`2026-05-18-diseno-comunicaciones-robusto-definitivo.md`), que sigue siendo el transporte canónico que CORRE. Las **capas fail-safe 0–6** de ese doc se **preservan**; CAN solo cambia las capas 1 (física) y 2 (framing). |
