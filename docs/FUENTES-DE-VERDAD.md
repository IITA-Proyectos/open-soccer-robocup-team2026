...
| **Convención de ejes de la cancha (X/Y/θ del robot)** | `docs/superpowers/specs/2026-05-25-localization-sprint1-trilateration-design.md` §4.1 + `src/top/config_top.h` (`FIELD_WIDTH_MM`, `FIELD_HEIGHT_MM`) + `docs/CONVENCION-EJES-ROBOT.md` (izq/der) | `docs/firmware/FIRMWARE-PLACA-ARRIBA.md` §6.4 líneas 369-377 (legacy con X=short/Y=long — INVERTIDA respecto al canónico) |
