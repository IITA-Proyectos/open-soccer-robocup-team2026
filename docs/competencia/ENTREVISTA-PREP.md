...
> (roster del repo: **Gustavo Viollaz** director del proyecto **no viaja**; viajan **Enzo Juárez Velázquez**
> coach principal, **Cecilia Budeguer** coach secundaria, y los competidores **María Virginia Viollaz** y
> **Elías Cordero**). En la entrevista **hablan los competidores presentes**; los coaches no responden por ellos.
...
- ✅ RESUELTO: compiten **María Virginia Viollaz** (visión/estrategia) y **Elías Cordero** (electro-mecánica), ambos 18. Viajan también **Enzo Juárez Velázquez (coach principal)** y **Cecilia Budeguer (coach secundaria)**; **Gustavo Viollaz (director del proyecto)** no viaja.
