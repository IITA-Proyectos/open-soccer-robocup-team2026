...
- **Consistencia entre deliverables.** Una sola cifra de tests (correr `scripts/run-host-tests.sh` el día previo — hoy **658/47/0**), un solo nombre de equipo, un solo nombre de la organización (✅ unificado a "Instituto de Innovación y Tecnología Aplicada"). Cifras o nombres contradictorios = munición para el juez.
