...
- **Consistencia entre deliverables.** Una sola cifra de tests (correr `scripts/run-host-tests.sh` el día previo — hoy **545/40/0**), un solo nombre de equipo, un solo nombre de la organización (hoy LICENSE dice "Innovación" y README "Informática"). Cifras o nombres contradictorios = munición para el juez.
