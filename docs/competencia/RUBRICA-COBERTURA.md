...
| Componente | Criterio | Pts máx | Dónde lo cubrimos (archivo + sección) | Nivel apuntado | Estimado hoy | Qué falta para el máximo |
|---|---|---:|---|---|---:|---|
| Video | **Easy to follow / un competidor par lo entiende** (criterio único, techo = Satisfactory=1) | 1 | `VIDEO-GUION.md` Bloques 1-5 (problema→solución→demo 60 suites verdes→receta→cierre, ~2:55, subtítulos EN) | Satisfactory (=1, máximo) | **0 hoy (guion, no video)** | **Grabar el video** con subtítulos EN. ✅ RESUELTO 2026-06-05: el comando en pantalla (Paso 3: `cd "software/teensy/Soccer 2026"` + `lib/Unity/src`) ya está corregido en el guion y la cifra ya está alineada a **834/60/0** (re-medido 2026-06-13). **Lo único que queda para el punto es GRABAR.** |
...
|---|---|---|
| `scripts/run-host-tests.sh` corrido **2026-06-13 17:43 ART** | **834 tests / 60 suites / 0 fallos (exit 0)** | **✅ Verificado — cifra viva vigente** |
| `TDP.md`, `POSTER.md`, `ENTREVISTA-PREP.md`, `BOM.md`, `VIDEO-GUION.md` | ~~403/33~~ → ~~658/47~~ → **834 / 60 / 0** | ✅ Re-propagado 2026-06-13 |
| Deliverables EN (`docs/competencia/en/`) + Fig.8 | **834 / 60 / 0** | ✅ A regenerar por pipeline (EN) / actualizar Fig.8 |
...
>
> ✅ **RE-MEDIDO 2026-06-13 17:43 ART:** cifra viva única **834/60/0** (secuencia de crecimiento 403 → 658 → 834). A propagar a los 12 deliverables ES+EN + Fig.8. Queda solo re-correr el runner el día previo a entregar por si la cifra cambió.
>
> 🔧 **HISTORIA 2026-06-13:** el `TDP.md` había DERIVADO a **717/51** (medición 2026-06-07) mientras el resto seguía en 658/47. Con la re-medición de las 17:43 ART (**834/60/0**) **toda la circulación se re-unifica a 834/60/0** — desaparecen las cifras intermedias (658/717/827). ⚠️ **Pendientes de cierre:** (1) `docs/competencia/en/TDP.md` se regenera por el **pipeline de traducción** a la cifra del día (NO editar `en/` a mano); (2) el día previo a entregar correr `python docs/competencia/assets/actualizar-cifra.py --apply` para bumpear TODO (ES+EN+Fig.8) a la cifra real de ese día. El tool aborta si hay 2 cifras distintas en circulación, por eso primero se re-unifica.
