...
| Componente | Criterio | Pts máx | Dónde lo cubrimos (archivo + sección) | Nivel apuntado | Estimado hoy | Qué falta para el máximo |
|---|---|---:|---|---|---:|---|
| Video | **Easy to follow / un competidor par lo entiende** (criterio único, techo = Satisfactory=1) | 1 | `VIDEO-GUION.md` Bloques 1-5 (problema→solución→demo 44 suites verdes→receta→cierre, ~2:55, subtítulos EN) | Satisfactory (=1, máximo) | **0 hoy (guion, no video)** | **Grabar el video** con subtítulos EN. ✅ RESUELTO 2026-06-05: el comando en pantalla (Paso 3: `cd "software/teensy/Soccer 2026"` + `lib/Unity/src`) ya está corregido en el guion y la cifra ya está alineada a 624/44/0. **Lo único que queda para el punto es GRABAR.** |
...
|---|---|---|
| `TDP.md`, `POSTER.md`, `ENTREVISTA-PREP.md`, `BOM.md` | ~~403 tests / 33 envs (2026-06-03)~~ → **624 / 44 / 0** | ✅ Actualizado 2026-06-05 |
| MEMORY del equipo | 470 / 37 (post-merge) | Histórico intermedio |
| `scripts/run-host-tests.sh` corrido 2026-06-04 | **624 tests / 44 suites / 0 fallos (exit 0)** | **Verificado** |
| `VIDEO-GUION.md` | 624 / 44 | Ya actualizado |
| Deliverables EN (`docs/competencia/en/`) + Fig.8 | 624 / 44 / 0 | ✅ Actualizado 2026-06-05 |
...
>
> ✅ **RESUELTO 2026-06-05:** cifra única **624/44/0** ya propagada a los 12 deliverables ES+EN + Fig.8. Queda solo re-correr el runner el día previo a entregar por si la cifra cambió.
