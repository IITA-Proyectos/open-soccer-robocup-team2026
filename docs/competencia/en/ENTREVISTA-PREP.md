...
> "We work by areas but with **a shared repository**: each change comes with its entry in the **engineering journal** and, if it touches a critical data point, the **SOURCES-OF-TRUTH** table is updated in the same commit. This way, no one depends on the memory of the other."
...
**Q: How do the boards communicate? What happens if a message is lost?**
