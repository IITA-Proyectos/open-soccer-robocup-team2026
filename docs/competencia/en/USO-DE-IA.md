...
> 📎 **Companion:** the underlying question "is it cheating?" is answered with verifiable evidence (RCJ rules, RoboCup mission, studies 2025-2026) in [`IA-VIBE-ENGINEERING-EVIDENCE.md`](IA-VIBE-ENGINEERING-EVIDENCE.md). This document (USO-DE-IA) explains the **HOW**; the companion argues the **WHY it is legitimate** and why competitions should promote it.
...
- *"How do we know the code works if it was written by AI?"* → Because **we do not trust AI, we trust the tests**: 834 host-native tests in green, golden contracts, and bench validation. The gate catches errors regardless of their source.
