...
date: 2026-06-05
status: draft-judged
language: Spanish-RiverPlate with burned-in English subtitles (subtitle before submission)
...
| **"Shows THE feature the team is MOST proud of"** | Met | Block 2 names the feature: **testing the robot's brain without the complete hardware** |
| **"Another competitor learns from it"** (replicability — RCJ gold standard) | Met | Block 4 provides the 3-step recipe for any team to copy |
...
> **Video closing: ≈ 2:58** — under the 3:00 limit. If the narration stretches, the first cut is the second half of the narration of Block 1 (0:10) or shorten Block 4.
...
- **Language / subtitles:** narration in **Spanish-RiverPlate** + **burned-in English subtitles** throughout the ENTIRE video. All overlaid texts in English.
- **Audio:** clear voice; soft and low background music, not overpowering the narration. Narrate slowly in Block 4 (the 3 steps are what the competitor needs to retain).
- **Legibility of terminals:** font ≥ 18 pt, high contrast, zoom on the line of the total tests. This is the key moment: the judge must READ the number.
...
| 6 | **[CAPTURE]** real screencast of the test suite + split code before/after | Capture | Blocks 3 and 4 |
