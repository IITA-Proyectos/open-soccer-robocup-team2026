...
| ¿En qué Serial del Teensy 4.0 entra la cámara trasera? | `01-hardware-y-conexion.md` §2 (**Serial7**, RX=28, TX=29, conector U9 — movida de Serial5 el 2026-05-29, que pasó a CENTRAL) |
...
|---|---|---|
| Serial del Teensy 4.0 | Serial3 (RX=15, TX=14) | **Serial7** (RX=28, TX=29 — movida de Serial5 el 2026-05-29) |
