...
#
# (Copia del kit de homografía, para la cámara TRASERA. Idéntico al del cameraFront-pack,
#  salvo que HMIRROR/VFLIP deben igualar los de cam-trasera-n6.py de ESTA cámara.)
#
# Qué hace
# --------
...
#
# ⚠️ La cámara trasera ve el área DETRÁS del robot. Calibrá su grilla con la lona
#    detrás. La rotación 180° para la fusión la hace el TOP (cameras_fusion), NO
#    esta H: acá reportás coords en el frame propio de la cámara, como la frontal.
#
...
#     en el campo de visión, alineada (origen y eje +Y marcados).
...
# ============================================================================
# Flip del montaje — DEBE ser IGUAL al de cam-trasera-n6.py de ESTA cámara, porque
...
print("=== CALIB HOMOGRAFIA N6 (TRASERA) ===  grilla %dx%d (%d puntos)" % (GRID_COLS, GRID_ROWS, N_EXPECTED))
