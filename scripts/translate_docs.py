"""Auto-translate official docs from ES to EN.

Adapted from rcj-2026-rescue-line-iita-salta-robocup.
Source: docs/official/es/ -> Target: docs/official/en/
...
SOURCE_DIR = pathlib.Path("docs/official/es")
TARGET_DIR = pathlib.Path("docs/official/en")
...
def main():
    ...
    if not SOURCE_DIR.exists():
        raise SystemExit(f"ERROR: {SOURCE_DIR} does not exist. Create docs/official/es/ first.")
