// main_centraledgefijo.cpp — entrypoint del programa AUTOCONTENIDO "centraledgefijo".
//
// Igual que centraledge PERO el rodeo es POR POSICIÓN PURA: NO usa la velocidad de la pelota
// (ni la predicción ni el bump) — solo la curva fija de amplificación de ángulo, como el rodeo
// SIMPLE de Edge (pedido de Elías). Para la versión CON anticipación por velocidad, ver la
// carpeta `centraledge`. centralmix queda PRISTINO. El env central_robot1_mix_edge_fijo compila
// SOLO esta carpeta (build_src_filter = +<centraledgefijo/> +<shared/>) con -DMIX_ATTACK_EDGE.
//
