...
// kp=1 / ki=0.2 / deadband 10° (tuning de banco de María 2026-06-14: "kp1 ki0.2 db10"),
...
inline PfmHeadingCfg pfm_heading_default_cfg() {
    // Valores de María (kp1/ki0.2/db10) PRESERVADOS + kd_rate=0 (amortiguación off).
    return PfmHeadingCfg{1.0f, 0.2f, 10.0f, 100.0f, 100.0f, 160, 0.0f};
}
