...
enum class TtCmd : uint8_t {
    ...
    TOF_SET_ROT,           // "TOF <n> ROT 0|90|180|270"  → arg=n, arg2=grados (firmware rota la mascara; ver -DTOP_ENABLE_TOF_ROT)
    TOF_SET_FLIP,          // "TOF <n> FLIP NONE|H|V"     → arg=n, arg2=flip (0=none,1=X,2=Y)
