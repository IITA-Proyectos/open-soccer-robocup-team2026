...
# TASK-105 — Modo DEBUG/telemetría en CENTRAL + app PC visual
...
## 6. Cambios de estado
- 2026-06-12 — creada (pending) como TASK-103. Fase 3 (P2); pedida por Elías en la práctica del delantero R1. Reusa el protocolo de TASK-304.
- 2026-06-15 — **renumerada TASK-103 → TASK-105** al consolidar la rama `banco/2026-06-12-elias-delantero-otos-r1` a main: el número 103 ya estaba ocupado por otra tarea distinta (`2026-06-13-task-103-pfm-arquero-deriva-rumbo-strafe.md`). Contenido intacto.
